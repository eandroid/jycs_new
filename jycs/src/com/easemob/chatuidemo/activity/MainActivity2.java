...
public class MainActivity2 extends BaseActivity implements EMEventListener,
    ...
    private ChildViewPager fragment_container;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lam = new LocalActivityManager(MainActivity2.this, true);
...
//         chatHistoryFragment = new ChatHistoryFragment();
        ...
        list_fragment.add(chatHistoryFragment);
        contactListFragment = new ContactlistFragment();
        list_fragment.add(contactListFragment);
        settingFragment = new SettingsFragment();
        list_fragment.add(settingFragment);
        MyViewPagerAdapter adapter = new MyViewPagerAdapter(
                getSupportFragmentManager(), list_fragment);
    ...
    private void initView() {
        fragment_container = (ChildViewPager) this
        ...
        fragment_container.setOnPageChangeListener(new OnPageChangeListener() {
        ...
        public void onInvitationReceived(String groupId, String groupName,
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (currentTabIndex == 0)
                        chatHistoryFragment.refresh();
                    if (CommonUtils.getTopActivity(MainActivity2.this).equals(
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        if (currentTabIndex == 0)
                            chatHistoryFragment.refresh();
                        if (CommonUtils.getTopActivity(MainActivity2.this)
    ...
    protected void onResume() {
        ...
        topView.setTitle("联系人");
        topView.setRightBtnDrawable(R.drawable.background_gift);
