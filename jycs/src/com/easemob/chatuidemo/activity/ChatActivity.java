...
public class ChatActivity extends BaseActivity implements OnClickListener,
    ...
    private void setUpView() {
        ...
        if (chatType == CHATTYPE_SINGLE) { // 单聊
            ...
            ((TextView) findViewById(R.id.name)).setText(im.getUsername());
            // conversation =
        ...
        if (msgCount < conversation.getAllMsgCount() && msgCount < pagesize) {
         ...
         adapter = new MessageAdapter(this, toChatUsername, chatType,im);
         // 显示消息
...
//    private void setLocalNameByImName() {
//        AbRequestParams params = new AbRequestParams();
//        params.put("imUsernames", toChatUsername);
//        Log.i(TAG, "当前聊天用户的环信id" + toChatUsername);
...
//                                if (user2 != null) {
//                                    name = user2.getName();
//                                    Log.i(TAG, "对应当前环信用户的本地服务器上的名字" + name);
...
//    }
    ...
    public void toGroupDetails(View view) {
        ...
        Log.i(TAG, "groupid" + toChatUsername);
        startActivityForResult(
