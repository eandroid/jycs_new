...
public class ContactAdapter extends ArrayAdapter<User> implements
    ...
    private Map<String,LocalIM> list_localim;
    //图片下载器
    private AbImageLoader mAbImageLoader = null;
    public ContactAdapter(Context context, int resource, List<User> objects,
            Map<String,LocalIM> list_localim) {
        super(context, resource, objects);
        this.context = context;
        this.res = resource;
        this.userList = objects;
        this.list_localim = list_localim;
...
//            holder.nameTextview.setText(user.getNick());
            holder.nameTextview.setText("我的申请");
            ...
            final LocalIM im = list_localim.get(username);
            if (im != null){
...
//            holder.nameTextview.setText(username);
                ...
                // 设置用户头像
                mAbImageLoader.display(holder.avatar,url);
...
//                    AbToastUtil.showToast(context, "点击了item");
